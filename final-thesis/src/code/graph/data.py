...
graph_66 = {
    'nodes': [(6734, 1453), (2233, 10), (5530, 1424), (401, 841),
              ...
              (1573, 2423), (244, 1299), (2866, 3187), (8323, 4683),
              (2853, 6417), (8944, 7752), (6207, 4244), (7416, 7461)],
    'edges': [[8, 7, 21, 22, 2, 80, 28], [25, 9, 40, 3],  # 2
              [21, 22, 40, 13],  # 3
              [25], [], [27, 36, 29, 35], [17, 27],  # 7
              [37, 21, 8, 90], [39, 37], [44, 23, 25, 41],  # 10
              [], [], [24, 46, 31],  # 13
              [24, 22], [39], [40, 21, 7],  # 16
              [26, 42, 69, 89, 95], [43, 45, 35],  # 18
              [26, 36], [32, 46, 29, 35], [],  # 21
              [], [], [31, 47, 44, 63, 96],  # 24
              [], [], [], [], [], [42, 35],  # 30
              [43, 37, 95, 52, 58], [38], [45],  # 33
              [], [44], [45], [], [],  # 38
...
def g_66():
    g = make_graph_from_data(graph_66)
    __clean(g)
    return g
...
graph_8 = {
    'nodes':
    [(500, 500), (360, 450), (280, 415), (220, 410), (190, 395), (160, 380),  # 6 kaire
     (450, 570), (430, 620), (450, 690), (460,
                                          750), (500, 930), (515, 1000),  # 12 virsu
     (460, 970), (440, 910), (380, 990), (150, 1100),  # 16
     (400, 700), (270, 700), (235, 705), (270, 560),
