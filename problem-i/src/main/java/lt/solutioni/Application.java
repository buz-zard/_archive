...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        savePerson(repository, personService, dateService, "Karolis",
                "Šarapnickis", "1990-07-13");
        savePerson(repository, personService, dateService, "Jonas", "Vandenis",
                "1970-07-13");
        savePerson(repository, personService, dateService, "Toma",
                "Lašytė-Vandenienė", "1970-07-13");
        savePerson(repository, personService, dateService, "Kamilė",
                "Vandenytė-Butkienė", "1993-07-13");
        savePerson(repository, personService, dateService, "Tomas",
                "Lašas-Vandenis", "1990-07-13");
    }

    // TODO: remove
    private static void savePerson(PersonRepository repository,
            PersonService personService, DateService dateService, String name,
            String surname, String dateOfBirth) {
        Person p = new Person(name, surname, dateService.getDate(dateOfBirth));
